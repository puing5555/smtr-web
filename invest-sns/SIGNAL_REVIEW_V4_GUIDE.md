...
signal-review-v4는 유튜버 시그널 검증 및 본사이트 동기화를 위한 완전한 시스템입니다.

## 🚀 주요 기능

### 1. 시그널 검증 리뷰
- Claude Sonnet 추출 시그널 168개 검토
...
node embed_v4.js
```
- 출력: `signal-review-v4-embedded.html` (477KB)
- 168개 시그널 + 리뷰 상태 + Opus 검증 결과 임베딩
...
├── signal-review-v4-embedded.html     # 임베딩된 리뷰 페이지
