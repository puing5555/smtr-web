...
### 현재 작업
- 시그널 100개 목표 (현재 81개, 19개 남음)
- V7→V9.1 재분석 완료 (삼프로 10개, +7 시그널)
- 자막 요약 36개 영상 DB 저장 완료
- DB에 28개 신규 영상 등록 (자막 없음)
- Selenium 9개 영상 자막 추출+분석 진행 중
- **대량 추출:** Webshare Residential Proxy + YouTubeTranscriptApi 제안 (답변 대기)
